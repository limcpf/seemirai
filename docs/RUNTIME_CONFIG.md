...
clean reconcile DB evidence도 preflight 기준 30초 freshness를 넘으면 stale로 보고 같은 tick의 private read preflight reconcile evidence를
새로 기록한다. recorder가 없거나 갱신 뒤에도 fresh clean evidence가 아니면 reconcile freshness guard가 broker 제출을 닫는다.
