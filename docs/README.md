...
- 제품 목표, historical MVP 범위, 사용자 시나리오: [`PRD.md`](./PRD.md)
- 기능 요구사항, acceptance criteria, 테스트 요구사항, production Live Ops 요구사항: [`FEATURE_REQUIREMENTS.md`](./FEATURE_REQUIREMENTS.md)
- Upbit KRW historical paper trading MVP 업무 명세: [`product-specs/upbit-krw-paper-trading-mvp.md`](./product-specs/upbit-krw-paper-trading-mvp.md)
...
- production Live Ops 설정 구조, legacy paper profile, 허용값, 안전 invariant: [`RUNTIME_CONFIG.md`](./RUNTIME_CONFIG.md)
