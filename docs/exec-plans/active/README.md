...
- [`2026-06-25-issue-244-live-ops-typescript-app-core.md`](./2026-06-25-issue-244-live-ops-typescript-app-core.md): Issue #244 Live Ops production 앱 코어 TypeScript화와 `dist/` 기반 thin CLI 전환 실행 계획.
