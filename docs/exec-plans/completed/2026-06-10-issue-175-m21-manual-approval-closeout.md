...
| 제출 직전 재검증 | risk, kill switch, reconcile freshness, budget, market, order type, notional, price deviation guard |
...
- 관련 vitest: 4 files, 44 tests 통과
- `./scripts/verify docs`: 문서 64개, 매니페스트 81개, 링크 215개 확인
- `git diff --check`: 통과
- `./scripts/verify`: 80 passed / 11 skipped test files, 1306 passed / 113 skipped tests
