  ...
  .object({
    ...
    autonomous_24x7: z
      .object({
        ...
        feature_window_ms: PositiveIntegerSchema.default(21 * 60_000),
        feature_min_trade_count: NonNegativeIntegerSchema.default(20),
        feature_min_orderbook_count: NonNegativeIntegerSchema.default(2),
        feature_max_latest_event_lag_ms: NonNegativeIntegerSchema.default(30_000),
